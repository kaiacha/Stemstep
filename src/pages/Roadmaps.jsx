...
const Roadmaps = () => {
    const softwarePath = [
        {
            title: 'High School',
            description: 'Focus on Math, Computer Science electives, and join a coding club.',
            duration: '4 Years',
            completed: true,
        },
        {
        ...
        },
        {
            ...
            description: 'Transfer to a 4-year university for a Bachelor\'s in Computer Science.',
            duration: '2 Years',
            completed: false,
        },
        {
    ...
    const engineeringPath = [
        ...
        },
        {
            ...
            description: 'Bachelor of Science in Mechanical or Electrical Engineering.',
            duration: '4 Years',
            completed: false,
        },
        {
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-12">
                    ...
                    <p className="text-lg text-text-muted max-w-2xl mx-auto">
                        Visualize your journey from where you are now to where you want to be.
                    </p>
                </div>

                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    <RoadmapMap title="Software Development Roadmap" steps={softwarePath} />
