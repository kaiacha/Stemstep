...
const FeatureCard = ({ icon: Icon, title, description, link, linkText }) => {
    return (
        <div className="bg-surface p-8 rounded-2xl shadow-sm border border-gray-100 hover:shadow-lg hover:scale-105 transition-all duration-300">
            ...
            {link && (
                <Link to={link} className="inline-flex items-center text-primary font-medium hover:text-primary-hover">
                    {linkText || 'Learn more'}
